...
export const DESTINATIONS: CuratedDestination[] = [
  ...
  },
  {
    ...
    type: 'hall_of_fame' as const,
    description: 'The oldest professional baseball park in America, built in 1910.',
    lat: 33.5212, lng: -86.8356,
    isMlbEvent: false,
    icon: '🏚️',
    heroColor: ['#1a1208', '#4d3a1a'],
  },
  {
    slug: 'jackie_robinson_museum',
    name: 'Jackie Robinson Museum',
    city: 'New York', state: 'NY', country: 'USA',
    type: 'hall_of_fame' as const,
    description: 'Celebrating the life and legacy of Jackie Robinson, opened 2022.',
    lat: 40.7195, lng: -74.0089,
    isMlbEvent: false,
    icon: '✊',
    heroColor: ['#0a1a2a', '#1a3a5a'],
  },
  {
